# Generated by Django 5.1.8 on 2025-08-18 15:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ifsc', models.CharField(default='n/a', max_length=15, verbose_name='IFSC code')),
                ('due_date', models.CharField(default=0, help_text='Enter in days', max_length=5, verbose_name='Payment Duration')),
                ('gsttype', models.CharField(blank=True, choices=[('0', 'No gst'), ('5', '5%'), ('24', '24%'), ('18', '18%')], default='Essential Goods', max_length=50, null=True, verbose_name='Gst Type')),
            ],
            options={
                'abstract': False,
            },
